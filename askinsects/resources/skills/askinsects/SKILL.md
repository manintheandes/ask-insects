...
Its first products are an SWD crop repellent and a human mosquito repellent. The active species include `Drosophila suzukii`, `Aedes aegypti`, major `Anopheles` malaria vectors, and diamondback moth (`Plutella xylostella`).
