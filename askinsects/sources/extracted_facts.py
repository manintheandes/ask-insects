...
FACT_FAMILIES: tuple[FactFamily, ...] = (
    ...
    FactFamily(
        ...
        field_terms={
            ...
            "copy_number": ("copy number", "copy-number", "copy number variation", "cnv", "cnv_normalized_bora"),
            "amplification": ("amplification", "amplified", "gene amplification", "genomic amplification"),
            "discriminating_concentration": ("discriminating concentration", "discriminating concentrations"),
            "fold_change": (
                "fold change",
                "fold_change",
                "fold_change_qpcr",
                "fold_change_normalized_bora",
                "fold_change_normalized_bora_qpcr",
                "fold_change_normalized_bora_ddpcr",
            ),
            "gene": ("gene", "gene id", "aael", "aael019678", "cceae", "cceae1a", "cceae3a"),
            "metabolic_marker": ("carboxylesterase", "cceae", "cceae1a", "cceae3a", "aael019678"),
    ...
    FactFamily(
        ...
        field_terms={
            "gene_identifier": ("gene id", "gene identifier", "ids", "symbols", "aael"),
            "protein_identifier": ("protein ids", "majority protein ids", "fasta headers", "uniprot"),
            "expression_metric": ("tpm", "fpkm", "rpkm", "count matrix", "normalized expression", "rna-seq", "transcriptome"),
            "protein_abundance_metric": (
                "ibaq",
                "lfq intensity",
                "intensity",
                "peptides",
