...
INATURALIST_ANNOTATION_MAP = {
    ...
    (1, 16): ("life_stage", "subimago"),
    (9, 10): ("sex", "female"),
    (9, 11): ("sex", "male"),
    (9, 20): ("sex", "cannot_be_determined"),
    (17, 18): ("alive_or_dead", "alive"),
    (17, 19): ("alive_or_dead", "dead"),
    (17, 20): ("alive_or_dead", "cannot_be_determined"),
    (22, 23): ("evidence_of_presence", "feather"),
    (22, 24): ("evidence_of_presence", "organism"),
    (22, 25): ("evidence_of_presence", "scat"),
    (22, 26): ("evidence_of_presence", "track"),
    (22, 27): ("evidence_of_presence", "bone"),
    (22, 28): ("evidence_of_presence", "molt"),
    (22, 29): ("evidence_of_presence", "gall"),
    (22, 30): ("evidence_of_presence", "egg"),
    (22, 31): ("evidence_of_presence", "hair"),
    (22, 32): ("evidence_of_presence", "leafmine"),
    (22, 35): ("evidence_of_presence", "construction"),
}
