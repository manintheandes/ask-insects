...
Source IDs: `mosquito_repellent_literature`, `mosquito_repellent_external_discovery`

This page covers mosquito repellent research since 2020 across article metadata, external discovery sources, datasets, preprints, patent-source status, and explicit source gaps.
...
External discovery breakdown:

| Lane | Source family | Records |
| --- | --- | ---: |
| datasets | DataCite | 62 |
| datasets | Figshare | 47 |
| datasets | Zenodo | 1 |
| literature | OpenAlex | 150 |
| literature | Semantic Scholar | 67 |
| literature | Europe PMC | 54 |
| literature | Crossref preprints | 44 |
| literature | AGRICOLA through Europe PMC | 6 |
| literature | native bioRxiv/medRxiv gap | 1 |
| literature | CABI gap | 1 |
