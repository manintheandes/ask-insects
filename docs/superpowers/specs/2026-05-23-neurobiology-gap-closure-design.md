...
- Public EM/CATMAID: Ask Insects indexes `htem/aedes_public`, its README CATMAID locator, public CATMAID project/stack/annotation/volume metadata, public skeleton export metadata, and public CSV inventories.
- Whole-brain connectome: Ask Insects keeps the complete female `Aedes aegypti` whole-brain Wellcome connectome bulk package as an external availability gap until a public downloadable dataset is found.
...
- Connectome answers must distinguish indexed public EM/CATMAID project and skeleton export metadata from the not-yet-downloadable Wellcome whole-brain bulk package.
