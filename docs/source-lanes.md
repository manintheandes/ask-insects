...
Moving-image video coverage is source-grade for the bounded PMC supplementary-video seed set, Dryad file-manifest layer, and Mendeley behavior/media file-manifest plus table layer. It is not comprehensive yet; OSF and challenge-video datasets remain follow-on work.
