...
- `drosophila_suzukii_video_atoms`: derived video-asset, thumbnail, keyframe, preview-clip, frame-manifest, and video-gap records from indexed spotted wing drosophila media and supplement video locators.
