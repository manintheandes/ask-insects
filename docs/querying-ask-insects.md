...
python3 -m askinsects --artifact-dir artifacts/mosquito-v1 ingest-image-atoms --mirror-images --max-image-mirrors 250 --max-image-bytes 5000000 --allowed-licenses cc-by,CC0,Creative Commons
