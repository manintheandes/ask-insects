...
python3 -m askinsects --artifact-dir artifacts/mosquito-v1 ingest-image-atoms --mirror-images --max-image-mirrors 1000 --max-image-bytes 5000000 --allowed-licenses cc-by,cc-by-nc,cc-by-sa,CC0,Creative Commons
