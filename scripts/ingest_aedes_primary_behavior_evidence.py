...
def ingest_aedes_primary_behavior_evidence(
    *,
    ...
    source_payload = {
        ...
        "method": "human-reviewed exact primary papers and atomic table locators",
    }
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Ingest exact primary Aedes behavior and repellent evidence."
    )
