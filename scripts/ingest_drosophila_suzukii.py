...
def ingest_drosophila_suzukii(
    *,
    ...
    if not refresh_failed:
        index.replace_source_records(DROSOPHILA_SUZUKII_SOURCE_ID, result.records)
    persist_source_gaps(index, DROSOPHILA_SUZUKII_SOURCE_ID, result.gaps, retrieved_at=retrieved_at)
